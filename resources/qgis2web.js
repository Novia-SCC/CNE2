...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [21.174090, 59.723010, 2995354.521387, 8622202.293253],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([2499486.680548, 8330167.288912, 3020414.530845, 8602856.378736], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carbon Neutral Experience CNE2.0</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (415 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'CNE 2.0 project focuses on sustainable tourism in Uusimaa and especially in terms of carbon footprint and emissions. The map gives an overview of responsible companies and destinations. The map also helps to understand if there are links and processes explaining the reasons why (and why not) companies and destinations made such a choice to become more responsible and what to do to promote that choice elsewhere. ';
            }
