...
map.getView().fit([2614705.024902, 8329342.213109, 2915128.902714, 8576669.510463], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carbon Neutral Experience 2.0</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (375 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'CNE 2.0 project focuses on carbon footprint and sustainable tourism in Uusimaa. The map gives an overview of responsible companies and destinations. The map also helps to understand if there are links and processes explaining the reasons why (and why not) companies and destinations made such choice to become more responsible and what to do to promote that choice elsewhere.';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_MunicipaltyinUusimaa_0,
    colName: 'Name (FIN)',
    zoom: 10,
    collapsed: true,
    map: map
