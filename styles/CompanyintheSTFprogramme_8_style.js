...
var style_CompanyintheSTFprogramme_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 6.4 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(4,179,254,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.76}), fill: new ol.style.Fill({color: 'rgba(255,255,255,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    }),new ol.style.Style({
        image: new ol.style.Circle({radius: 1.4 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(4,179,254,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(92,96,202,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
